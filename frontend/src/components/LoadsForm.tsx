...
const LoadsForm: FC<LoadsFormProps> = ({ onUpdate }) => {
    ...
    useEffect(() => {
        const fetchLoads = async () => {
            try {
                const response = await axios.get(
                    "${import.meta.env.VITE_API_BASE_URL}/api/loads/",
                );
    ...
    const handleAddLoad = async () => {
        ...
        try {
            const response = await axios.post("${import.meta.env.VITE_API_BASE_URL}/api/loads/", {
    ...
    const handleDeleteAllLoads = async () => {
        ...
        try {
            await axios.delete("${import.meta.env.VITE_API_BASE_URL}/api/loads/");
            setLoads([]);
